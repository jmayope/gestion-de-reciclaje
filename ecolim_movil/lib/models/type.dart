...
class Type {
  ...
  bool operator ==(Object other) => identical(this, other)
    || other is Type && id == other.id && category == other.category && code == other.code && name == other.name && descripcion == other.descripcion && status == other.status && createdAt == other.createdAt && createdBy == other.createdBy && updatedAt == other.updatedAt && updatedBy == other.updatedBy && image == other.image && order == other.order;

...
public class MenuAdmin extends JFrame {
    ...
    private void crearMenuLateral() {
        ...
        btnUsuarios = crearBoton("Usuarios", y);
        y += espacio;
        btnRoles = crearBoton("Roles", y);
        y += espacio;

        btnUser = crearBoton("Usuario para empresa", y);
        y += espacio;
        btnEntity = crearBoton("Empresas", y);
        y += espacio;
        btnPeople = crearBoton("Personas", y);
        y += espacio;
        btnDevices = crearBoton("Dispositivos", y);
        y += espacio;

        btnType = crearBoton("Tipos", y);
        y += espacio;

        btnUbicaciones = crearBoton("Ubicaciones", y);
        y += espacio;
        btnPlantas = crearBoton("Plantas", y);
        y += espacio;
        btnRegistros = crearBoton("Residuos", y);
        y += espacio;
        btnReportes = crearBoton("Reportes", y);
        y += espacio;
        btnEstadisticas = crearBoton("Estadísticas", y);
        y += espacio;
